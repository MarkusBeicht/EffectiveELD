...
for domainid in eukdomains.keys():
  ...
  m = numpy.mean(genomecounts)
  s = numpy.std(genomecounts)
  median = numpy.median(genomecounts)
  iq = iqr(genomecounts)
  doutfile.write("%s\t%s\t%i\t%i\t%i\t%i\t%i\t%i\t%i\n" % (domainid, description, median, iq, threshold, threshold_01, threshold_03, threshold_05, threshold_07))
  #doutfile.write("%s\t%s\t%f\t%f\t%i\t%i\t%i\t%i\t%i\n" % (domainid, description, m, s, threshold, threshold_01, threshold_03, threshold_05, threshold_07))
  sys.stdout.flush()
sys.stderr.write("\n")
